...
class HabitCard extends StatelessWidget {
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        ...
                        _getCategoryColor(habit.category).withOpacity(0.7),
                      ],
                    ),
                      ...
                      decoration: BoxDecoration(
                        gradient:
                            isCompletedToday
                                ...
                                : null,
                        color:
                            isCompletedToday ? null : const Color(0xFFF1F5F9),
                        borderRadius: BorderRadius.circular(16),
                        boxShadow:
                            isCompletedToday
                                ? [
  ...
  void _confirmDeleteHabit(BuildContext context) {
    ...
    habitProvider.deleteHabit(authProvider.currentUser!.uid, habit.id);
  }
}
