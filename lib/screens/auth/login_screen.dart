...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _showErrorDialog(String message) {
    final isAuthServiceError =
        message.contains('Authentication service error') ||
              ...
              children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                          color: const Color(0xFF764ba2).withOpacity(0.8),
                        ),
                      ),
                    ],
                  ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (authProvider.error!.contains(
                ...
                if (authProvider.error != null &&
                  ...
                  Padding(
                    ...
                    child: OutlinedButton(
                      onPressed:
                          authProvider.isLoading ? null : _retryAuthentication,
                      style: OutlinedButton.styleFrom(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 24,
                          vertical: 16,
