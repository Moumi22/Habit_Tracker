...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _checkAuthState() async {
    ...
    // Wait a bit more for auth state to be properly initialized
    ...
    print('Local auth state check: $isLoggedIn');

    if (!mounted) return;

    if (isLoggedIn) {
      // User is logged in, navigate to main screen
      print('User is logged in locally, navigating to main screen');
      Navigator.of(context).pushReplacementNamed('/main');
    } else {
