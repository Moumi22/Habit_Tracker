...
class _QuotesScreenState extends State<QuotesScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Failed to load quotes. Using offline quotes.'),
  ...
  Future<void> _onRefresh() async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Refresh failed. Using cached quotes.'),
            backgroundColor: Colors.orange,
          ),
        );
      }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip:
                _showFavoritesOnly ? 'Show all quotes' : 'Show favorites only',
          ),
        ],
      ),
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: QuoteCard(quote: quote, showActions: true),
                        );
                      },
                    ),
                  ),
  ...
  Widget _buildEmptyState() {
    final message =
        _showFavoritesOnly ? 'No favorite quotes yet' : 'No quotes available';
