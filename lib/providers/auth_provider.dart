...
class AuthProvider extends ChangeNotifier {
  ...
  void _initializeAuth() async {
    try {
      ...
      final restored = await _authService.restoreAuthState();
      print('Auth state restoration result: $restored');
      
      // Check if there's a current user immediately
      _currentUser = _authService.currentUser;
      if (_currentUser != null) {
        print('Found current user: ${_currentUser!.uid}');
        ...
        (User? user) {
          try {
            ...
            if (user != null) {
              ...
              _authService.saveUserSession(user.uid);
            } else {
              _userData = null;
